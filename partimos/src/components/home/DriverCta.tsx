    ...
    <section className="pb-16 md:pb-[76px]">
      <Container>
        <div className="lg:pl-[var(--rail-gutter)]">
          <div className="relative overflow-hidden bg-plate-50 px-7 py-9.5 min-[860px]:px-12 min-[860px]:py-13">
            <div
              aria-hidden
            ...
            <div className="relative z-[2] max-w-[52ch]">
              ...
              <p className="mb-6 text-[16.5px] leading-relaxed text-plate-600">
