    ...
    <main id="contenido" className="bg-plate-50 pb-16">
      <Container className="pt-5">
        <nav
          ...
          className="mb-4 text-[13px] text-plate-600"
        >
          <Link
            href={`/buscar?desde=${corridor.origin.slug}&hacia=${corridor.destination.slug}&fecha=${date}`}
            className="inline-flex items-center gap-1.5 py-1 font-semibold hover:text-plate-900"
          >
        ...
        <Suspense fallback={<DetailSkeleton />}>
          <TripDetail trip={trip} corridor={corridor}>
            <section className="border border-plate-200 bg-white p-5 sm:p-6">
              <h2 className="mb-4 text-[18px] font-bold">Quién maneja</h2>
              <div className="flex items-center gap-4">
                ...
                <div className="min-w-0">
                  ...
                  <p className="cote flex flex-wrap items-center gap-x-2 gap-y-0.5 text-[13.5px] text-plate-600">
              ...
              <ul className="mt-4 grid gap-2 border-t border-plate-200 pt-4">
  ...
  return (
    ...
    >
      <div className="grid gap-5">
        <div className="h-[340px] border border-plate-200 bg-white" />
        <div className="h-[220px] border border-plate-200 bg-white" />
        <div className="h-[260px] border border-plate-200 bg-white" />
      </div>
      <div className="h-[520px] border border-plate-200 bg-white" />
    </div>
  );
}
...
function Badge({
  ...
  return (
    <li className="flex items-center gap-2.5 text-[14px] text-plate-600">
      <Icon name={icon} className="size-4.5 shrink-0 text-plate-600" />
      {children}
    </li>
  );
}
